...
import io.ocepgen.modules.sys.dto.PasswordDTO;
import io.ocepgen.modules.sys.dto.SysUserDTO;
import io.ocepgen.modules.sys.excel.SysUserExcel;
...
public class SysUserController {
    ...
    public Result<List<SysUserDTO>> getStudent(@ApiIgnore @RequestParam Map<String, Object> params) {
    ...
    @GetMapping("teacher")
    @ApiOperation("教师列表")
    @RequiresPermissions("sys:user:teacher")
    public Result<List<SysUserDTO>> getTeacher(@ApiIgnore @RequestParam Map<String, Object> params) {
        List<SysUserDTO> data = sysUserService.getTeacherList(params);
