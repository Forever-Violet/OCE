...
import io.ocepgen.modules.sys.dao.SysParamsDao;
import io.ocepgen.modules.sys.dto.SysParamsDTO;
import io.ocepgen.modules.sys.entity.SysParamsEntity;
import io.ocepgen.modules.sys.redis.SysParamsRedis;
...
public class SysParamsServiceImpl extends BaseServiceImpl<SysParamsDao, SysParamsEntity> implements SysParamsService {
    ...
    public <T> T getValueObject(String paramCode, Class<T> clazz) {
        ...
        try {
            ...
            throw new OcepgenException(ErrorCode.PARAMS_GET_ERROR);
        }
    }
