...
package io.ocepgen.common.redis;
...
public class RedisKeys {
     ...
     * 验证码发送次数Key
     */
    public static String getCaptchaPostTimesKey(String key){
        return "sys:captcha:times:" + key;
    }
     ...
     * 数据展示Key
     */
    public static String getDataDisplayKey(String key){
