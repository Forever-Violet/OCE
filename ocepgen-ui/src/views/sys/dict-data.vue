<template>
  <div class="mod-sys__dict">
    <el-form :inline="true" :model="state.dataForm" @keyup.enter="state.getDataList()">
      <el-form-item>
        <el-input v-model="state.dataForm.dictValue" placeholder="字典值" clearable @change="state.getDataList()">
          <template #prefix>
      ...
      <el-form-item>
        <el-input v-model="state.dataForm.dictLabel" placeholder="字典标签" clearable @change="state.getDataList()">
          <template #prefix>
            <el-button link @click="state.getDataList()" style="width: 20px;margin-left: -11px;align-content: center;">
              <el-icon class="el-input__icon">
                <search/>
