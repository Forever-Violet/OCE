  ...
  <div class="mod-sys__semester">
    <el-form :inline="true" :model="state.dataForm" @keyup.enter="state.getDataList()">
      ...
      <el-form-item v-if="hasSchoolListPermission">
        <el-select v-model="state.dataForm.schoolId" placeholder="选择学校" @change="state.getDataList()" clearable> <!--单选 去掉multiple-->
      ...
      <el-form-item>
        <el-button v-if="state.hasPermission('sys:semester:export')" type="info" @click="state.exportHandle()">导出</el-button>
      </el-form-item>
